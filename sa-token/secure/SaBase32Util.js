...
// // 使用 IIFE 替代 static {} 块进行初始化  暂不启用
// (() => {
//     for (let i = 0; i < SaBase32Util.BASE32_CHARS.length; i++) {
//         const c = SaBase32Util.BASE32_CHARS[i]; // 使用索引访问字符
//         const code = c.charCodeAt(0);
//         SaBase32Util.BASE32_LOOKUP[code] = i;

//         // 支持小写字母 a-z
//         if (c >= 'A' && c <= 'Z') {
//             const lowerCode = c.toLowerCase().charCodeAt(0);
//             SaBase32Util.BASE32_LOOKUP[lowerCode] = i;
//         }
//     }
// })();

export default SaBase32Util;
