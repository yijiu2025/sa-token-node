...
var StpUtil = require('./stp/StpUtil.js');
...
require('./exception/ApiDisabledException.js');
require('./exception/DisableServiceException.js');
var SaTokenConfigFactory = require('./config/SaTokenConfigFactory.js');
require('./context/SaTokenContext.js');
var SaTokenContextForThreadLocal = require('./context/SaTokenContextForThreadLocal.js');
var SaTokenDaoDefaultImpl = require('./dao/SaTokenDaoDefaultImpl.js');
var SaHttpTemplateDefaultImpl = require('./http/SaHttpTemplateDefaultImpl.js');
var SaJsonTemplateDefaultImpl = require('./json/SaJsonTemplateDefaultImpl.js');
var SaLogForConsole = require('./log/SaLogForConsole.js');
var SaSameTemplate = require('./same/SaSameTemplate.js');
var SaTotpTemplate = require('./secure/totp/SaTotpTemplate.js');
var SaSerializerTemplateForJson = require('./serializer/impl/SaSerializerTemplateForJson.js');
var StpInterfaceDefaultImpl = require('./stp/StpInterfaceDefaultImpl.js');
var SaTempTemplate = require('./temp/SaTempTemplate.js');
...
class SaManager {
    ...
    static setConfig(config) {
        ...
        // 触发全局配置变更事件 $$ 全局事件 
        SaTokenEventCenter.default.doSetConfig(config); 
    ...
    static setSaTokenDao(saTokenDao) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaTokenDao", saTokenDao);
    }
    ...
    static setStpInterface(stpInterface) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("StpInterface", stpInterface);
    }
    ...
    static setSaTokenContext(saTokenContext) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaTokenContext", saTokenContext);
    }
    ...
    static setSaTempTemplate(saTempTemplate) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaTempTemplate", saTempTemplate);
    }
    ...
    static setSaJsonTemplate(saJsonTemplate) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaJsonTemplate", saJsonTemplate);
    }
    ...
    static setSaHttpTemplate(saHttpTemplate) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaHttpTemplate", saHttpTemplate);
    }
    ...
    static setSaSerializerTemplate(saSerializerTemplate) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaSerializerTemplate", saSerializerTemplate);
    }
    ...
    static setSaSameTemplate(saSameTemplate) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaSameTemplate", saSameTemplate);
    }
    ...
    static setLog(log) {
        this.log = log;
        SaTokenEventCenter.default.doRegisterComponent("SaLog", log);
    }
    ...
    static setSaTotpTemplate(totpTemplate) {
        ...
        SaTokenEventCenter.default.doRegisterComponent("SaTotpTemplate", totpTemplate);
    }
...
const log = SaManager.log;

exports.default = SaManager;
exports.log = log;
