...
var SaSerializerTemplate = require('../SaSerializerTemplate.js');
...
class SaSerializerTemplateForJson extends SaSerializerTemplate {
	...
	// @Override
	objectToString(obj) {
		return SaManager.default.getSaJsonTemplate().objectToJson(obj);
	}
	...
	stringToObject(str, type) {
		return SaManager.default.getSaJsonTemplate().jsonToObject(str, type);
	}
...
module.exports = SaSerializerTemplateForJson;
