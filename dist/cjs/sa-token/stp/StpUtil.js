...
require('./parameter/enums/SaReplacedRange.js');
require('./parameter/enums/SaLogoutMode.js');
require('./parameter/enums/SaLogoutRange.js');
var StpLogic = require('./StpLogic.js');
...
class StpUtil {
	...
	static setStpLogic(newStpLogic) {
		...
		SaManager.default.putStpLogic(newStpLogic);
		
		// 3、$$ 发布事件：更新了 stpLogic 对象
		SaTokenEventCenter.default.doSetStpLogic(this.stpLogic);
	}
