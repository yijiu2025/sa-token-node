...
var SaCookieConfig = require('../../config/SaCookieConfig.js');
...
class SaLoginParameter {
	 ...
	 */
	static create() {
		return new SaLoginParameter(SaManager.default.getConfig());
	}
...
module.exports = SaLoginParameter;
