...
var SaTokenDao = require('../SaTokenDao.js');
...
class SaTimedCache {
    ...
    async initRefreshThread() {
        ...
        const config = await SaManager.default.getConfig();
        ...
        const refreshTask = () => {
            ...
            refreshPeriod = SaManager.default.getConfig().getDataRefreshPeriod();
            if(refreshPeriod <= 0) {
				refreshPeriod = 1;
            }
