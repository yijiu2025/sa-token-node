...
var SaApplication = require('../application/SaApplication.js');
...
class SaHolder {
     ...
     */
    static getContext() {
      return SaManager.default.getSaTokenContext()
    }
     ...
     */
    static getRequest() {
      const ctx = SaManager.default.getSaTokenContext();
    ...
    static async getStorage() {
      const ctx = await SaManager.default.getSaTokenContext();
      if (!ctx) throw new Error('SaTokenContext 未初始化')
    ...
    static getApplication() {
      if (!SaApplication.default.defaultInstance) {
        throw new Error('SaApplication 未初始化')
      }
      return SaApplication.default.defaultInstance
    }
  }
