...
var SaTokenListener = require('./SaTokenListener.js');
...
class SaTokenListenerForLog extends SaTokenListener {
	...
	doDisable(loginType, loginId, service, level, disableTime) {
		SaManager.log.info("账号 {} [{}服务] 被封禁 (loginType={}), 封禁等级={}, 解封时间为 {}", loginId, loginType, service, level, SaFoxUtil.formatAfterDate(disableTime * 1000));
	}
...
module.exports = SaTokenListenerForLog;
