...
var SameTokenInvalidException = require('../exception/SameTokenInvalidException.js');
...
class SaSameTemplate {
    ...
    saveToken(token) {
        ...
        const timeout = SaManager.default.getConfig().getSameTokenTimeout();
        SaManager.default.getSaTokenDao().set(key, token, timeout);
    }
	 ...
	 */
	getTokenNh() {
        return SaManager.default.getSaTokenDao().get(this.splicingTokenSaveKey());
    }
	 ...
	 */
	getPastTokenNh() {
        return SaManager.default.getSaTokenDao().get(this.splicingPastTokenSaveKey());
    }
	 ...
	 */
	getTokenTimeout() {
        return SaManager.default.getSaTokenDao().getTimeout(this.splicingTokenSaveKey());
    }
	...
	splicingTokenSaveKey() {
        return SaManager.default.getConfig().getTokenName() + ":var:same-token";
    }
	...
	splicingPastTokenSaveKey() {
        return SaManager.default.getConfig().getTokenName() + ":var:past-same-token";
    }

}

module.exports = SaSameTemplate;
